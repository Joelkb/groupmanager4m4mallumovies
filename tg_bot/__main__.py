...
ഹായ് {}, എന്റെ പേര് {}! ഞാൻ [ഈ ഗ്രൂപ്പ്](https://t.me/m4_mallumovies) നോക്കി നടത്തുന്ന ഒരു അടിപൊളി അഡ്മിൻ ബോട്ടാണ്.
...
DONATE_STRING = """My Creator is the owner of [M4 MALLUMOVIES] (https://t.me/m4_mallumovies) group."""
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username))],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/joinchat/8i064A8O6zYzZWY1"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/joinchat/LJRsBp82HiJhNDhl")],
...
def main():
    ...
    donate_handler = CommandHandler("creator", donate)
